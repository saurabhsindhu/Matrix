...
- (void) setup
{
	...
	coverFlowLayout.cellSize = CGSizeMake(200.0f, self.frame.size.height);
    coverFlowLayout.cellSpacing = 192.0f;
...
- (void)scrollByFractionalValue:(float)value
{
	...
	CGPoint newOffset = CGPointMake(startingContentOffset.x + 130 * value, startingContentOffset.y);
